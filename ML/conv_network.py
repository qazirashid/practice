...
#This is a output of a practice session in Machine Learning. 
# The skeleton and guiding comments / hints were all provided by the Coursera course instructor for 
# deep learning offered by DeepLearning.ai and taught by Andrew Ng. 
# My input is limited to filling in the blanks as part of assignment, which is quite an easy task relative to building this script from scratch. 
