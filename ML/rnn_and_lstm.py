...
def rnn_forward(x, a0, parameters):
    ...
    #Create a zero tensor of the shape (n_a, m, T_x)
    y_pred = np.zeros((n_y, m, T_x))
    #Create a prediction tensor (array) of the shape (n_y, m, T_x)
    
    # Initialize a_next (≈1 line)
    a_next = a0
    #Initilize the first hidden state as the value given in the function argument.
