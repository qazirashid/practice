...
def data_augmenter():
    ...
    data_augmentation.add(RandomFlip(mode='horizontal', seed=None,))
...
def alpaca_model(image_shape=IMG_SIZE, data_augmentation=data_augmenter()):
    ...
    #base_model was constructed byy downloading MobileNetV2 model that is pretrained on imageNetData. 
    # The base model does not include the last layer of standard MOibleNetV2 model. 
    # freeze the base model by making it non trainable
    #We will freeze all exiting layers of the base_model by setting the model's 'trainable' parameter to False 
    base_model.trainable = False 
...
#FineTune Learning rate set to 10% of gross learning rate 
