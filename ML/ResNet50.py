...
def identity_block(X, f, filters, training=True, initializer=random_uniform):
    ...
    # First component of main path
    #The first CONV2D has F1 filters of shape (1,1) and a stride of (1,1). Its padding is "valid". 
    ...
    # The second CONV2D has F2 filters of shape (f,f) and a stride of (1,1). Its padding is "same". 
    # Use 0 as the seed for the random uniform initialization: kernel_initializer = initializer(seed=0).
    # The second BatchNorm is normalizing the 'channels' axis.
    #Then apply the ReLU activation function. This has no hyperparameters.
    ...
    # The third CONV2D has F3 filters of shape (1,1) and a stride of (1,1). Its padding is "valid". 
    # Use 0 as the seed for the random uniform initialization: kernel_initializer = initializer(seed=0).
    # The third BatchNorm is normalizing the 'channels' axis.
